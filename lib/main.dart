...
const String defaultchatbotName = "Jarvis";
            ...
            new Expanded(
              child: new Column(
                ...
                children: <Widget>[
                  ...
                  new Container(
                    margin: const EdgeInsets.only(top: 6.0, left: 210.0),
                    child: new Text("Jarvis",
                        style: Theme.of(ctx).textTheme.subhead),
                  ),
                  // new Container(
                  //   margin: const EdgeInsets.only(left: 240),
                  //   child: new CircleAvatar(child: new Text(defaultchatbotName[0]),
                  //   ),
                  // ),
                  new Container(
                    margin: const EdgeInsets.only(top: 6.0, left: 210.0),
